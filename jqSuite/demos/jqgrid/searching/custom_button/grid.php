...
$grid->navigator = true;
$grid->setNavOptions('navigator', array("add"=>false, "del"=>false,"excel"=>true,"search"=>true,"refresh"=>false));
...
// definition of custom button in edit form
	"buttons" => array(
		array(
			'side' => "right",
			'text' => "Custom",
			'position' => "first",
			'click' => 'js:function( form, params, event) {
