...
$grid->setColProperty("OrderDate", array(
	...
	"unformat"=>"js:function(v,b,c){ return $.jgrid.parseDate.call(this, 'd.m.Y', v, 'Y-m-d') ; }",
    "search"=>false,
    )
);
...
$grid->setNavOptions('edit', array("height"=>'auto',"dataheight"=>"auto", "width"=>"auto", "reloadAfterSubmit"=>true));
$grid->setNavOptions('add', array("height"=>'auto',"dataheight"=>"auto", "width"=>"auto", "reloadAfterSubmit"=>true));
